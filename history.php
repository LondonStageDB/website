            ...
            <div class="grid-x history-section">
                <div id="Project" class="small-12" data-magellan-target="Project">
                    <img alt="image of title page of The London Stage reference books"
                         style="float:right;padding-left:25px;width:250px;height:340px;"
                    ...
                    <p>In the 1970s, the editors of <i>The London Stage</i>
                        ...
                        decade with the support from the National Endowment for the Humanities, the American Council of
                        ...
                        artifact of the project that remained in circulation was the <a
                                href="https://catalog.hathitrust.org/Record/000299859"><i>Index to the London Stage</i></a>,
                    ...
                    <p>In 2013, Mattie Burkert began investigating the history of the <i>Information Bank</i>, drawing
                        on the archives at Lawrence University, where the original project was housed.
                        She also got in touch with the people involved in the <i>Information Bank</i> project, including
                    ...
                    <p>From 2018 to 2019, with the support of <a href="#Funding">the National Endowment for the
                            Humanities and other funders</a>, Burkert and a <a href="#Team">team of researchers,
                    ...
                    <p>In 2020, Burkert moved to the University of Oregon and worked with developers there to migrate
                        the site to UO servers; the following spring, the team launched a major update with improvements
                        to the security and efficiency of the site, with a particular focus on the speed and accuracy of
                        searches. Users can use the <a href="/">keyword</a> or <a href="/search.php">
                            advanced search</a> pages to seek information about specific actors, theaters, play titles,
                    ...
                    <p>These open access and open source values distinguish the <i>London Stage Database</i> from
                        ...
                        portal developed by publisher Adam Matthew. Furthermore, the media archaeological nature of our
                        project informs our team's commitment to transparency about our sources, our decisions,
                        and the limitations of our work. Like any resource of its kind, the <i>London Stage Database</i>
                    ...
                    <p> To read more about our approach to the data in this project, visit the <a href="about-data.php">About
                            the Data</a> page.
                </div>
            </div>
