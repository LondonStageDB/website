        ...
        <div class="cell small-12 medium-6 phases-wrap">
          ...
          <ul class="image-wrap2 slides">
            <li class="book-pdf2 responsive-embed2">
              ...
              <object data="https://d2t4ih0hdl57c1.cloudfront.net/images/pdfs/<?php echo $event['BookPDF']; ?>" type="application/pdf" height="725px" width="532px">
                <p>Your web browser doesn't have a PDF plugin. Instead, <a href="https://d2t4ih0hdl57c1.cloudfront.net/images/pdfs/<?php echo $event['BookPDF']; ?>">click here to download the PDF file</a></p>
              </object>
              <?php else : ?>
