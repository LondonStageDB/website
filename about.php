        ...
        <div class="grid-x about-section">
          <div id="Funding" class="small-12" data-magellan-target="Funding">
            ...
            <div class="logo-wrap grid-x">
              ...
              <div class="small-12 medium-6 large-3"><a href="https://chass.usu.edu/"><img class="funding-logo" src="/images/CHASS-logo-black.svg" alt="CHASS Logo" /></a></div>
              <div class="small-12 medium-6 large-3"><a href="http://rgs.usu.edu/"><img class="funding-logo" src="/images/ResearchBlackTower.png" alt="USU Research Logo" /></a></div>
            </div>
          </div>
        </div>
        <!-- End Funding -->
