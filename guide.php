      ...
      <div id="top" class="small-12 medium-8 large-9 guide-content">
        ...
        <div class="grid-x guide-section">
          <div id="Queries" class="small-12" data-magellan-target="Queries">
            <h2>Queries</h2>
            <p>At the top left of the search results page appears a link that reads "Toggle Query." Click this link to view the way that your search was translated into the database programming language SQL (Structured Query Language) in order to generate the results that you see. Relational databases like the <i>London Stage Database</i> are organized as a series of <b>tables</b> (imagine Excel spreadsheets) with <b>fields</b> (imagine the column labels within those spreadsheets). For example, the <i>London Stage Database</i> has a table called "Events," and within that table, it has a field called "EventDate" that holds the date for each event. When you perform a search, your parameters are transformed into a series of commands that create links and interactions among our different tables (Events, Performances, Theatre, etc.). If you want to learn more about SQL, you can find a number of free tutorials and courses available online.</p>
          </div>
        </div>
        <!-- End Queries -->
        <div class="grid-x guide-section">
