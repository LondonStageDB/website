  ...
  <div id="main" class="main grid-container">
    <div class="grid-x dates-wrap">
      ...
      <div method="post" class="small-12 medium-11 large-9 cell grid-x dates-form">
        ...
        <p>In <i>The London Stage, 1660-1800</i>, the Old Style month and day of a performance are retained, but the year is assumed to begin on January 1, as in the New Style. Consequently, a performance with a full Old/New Style date of "10/21 January 1665/66" is recorded as taking place on "10 January 1666." The <i>London Stage Database</i> replicates the dates from the reference books. Users wishing to compare performance offerings in England with those in other countries should be aware of these dating issues and make the appropriate conversions.
        </p>
      </div>
    </div>
  </div>
